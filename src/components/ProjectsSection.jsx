    ...
    <section id="projects" className='py-24 px-4 relative'>
        <div className='container mx-auto max-w-5xl'>
            ...
            <p className='text-center text-muted-foreground mb-12 max-w-2xl mx-auto'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Autem odit nemo rem ad fugiat provident aut ducimus temporibus architecto omnis.
            </p>
            ...
            <div className='text-center mt-12'>
                <a href="" target='_blank' className='cosmic-button w-fit flex items-center mx-auto gap-2'>Check My Github <ArrowRight size={16}/></a>
